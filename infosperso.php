                    ...
                    <div class="row"> <!-- align 12 colonnes -->
                        <div class="col-lg-3 col-sm-12 mb-5">
                            <div class="bg-gris rounded-5 pt-3 ">
                                ...
                                <div class="lignebotb bg-bleu d-flex flex-column pt-3 pb-3">
                                    <h3 class="ps-4 titre">Coordonnées</h3>
                                    <a href="/" title="" target="" class="ps-5 pe-4 text-light">Informations personnelles <i class="fas fa-angle-right"></i></a>
                                    <a href="/" title="" target="" class="ps-5 pe-4 text-light">Identifiants <i class="fas fa-angle-right"></i></a>
                                    <a href="/" title="" target="" class="ps-5 pe-4 text-light">Se déconnecter <i class="fas fa-angle-right"></i></a>
                                </div>
                                <div class="p-4">
