                    ...
                    <div class="row"> <!-- align 12 colonnes -->
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="bg-gris rounded-5 p-5">
                                <div class="row">
                                    <div class="col-12">
                                        <h2 class="lignebotb">Messages reçu</h2>
                                        ...
                                        <div class="p-4 d-flex bg-light rounded-5 justify-content-around">
                                            ...
                                            <button type="submit" class="btn btn-contourblue p-1 rounded-3"><a href="" class="btn-blue rounded-3 p-1">Nous écrire</a></button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
